...
export const chatCopy: Record<Language, ChatCopy> = {
  en: {
    ...
    speakHint: 'Turn the iPhone ringer on. After the reply, tap HEAR ANSWER to play it out loud.',
    listening: 'LISTENING',
  ...
  no: {
    ...
    speakHint: 'Slå på ringelyden. Etter svaret, trykk HØR SVARET for å spille det.',
    listening: 'LYTTER',
