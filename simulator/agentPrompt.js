const AGENT_PROMPT_VERSION = 'sogn-safe-agent-v1';

const SOGN_SAFE_SYSTEM_PROMPT = `You are the SOGN SAFE civilian emergency assistant.
...
module.exports = { AGENT_PROMPT_VERSION, SOGN_SAFE_SYSTEM_PROMPT };
